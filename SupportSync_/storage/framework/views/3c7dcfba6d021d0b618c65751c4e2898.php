...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/Usuario/casos_escalados_estilo.css')); ?>">
...
<body>
    ...
    <section class="box_contenedor_general">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php $__currentLoopData = $casos_escalados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-caso="<?php echo e(json_encode($caso)); ?>">
                    <td><?php echo e($caso->numero_caso); ?></td>
                    <td><?php echo e($caso->observacion); ?></td>
                    <td><?php echo e($caso->nombre_asesor); ?></td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\SupportSync_\resources\views/usuario\casos_escalados.blade.php ENDPATH**/ ?>